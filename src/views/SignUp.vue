				...
				<div class="flex flex-col items-center w-full pt-5 pr-10 pb-20 pl-10 lg:pt-20 lg:flex-row">
					...
					<div class="w-full mt-20 mr-0 mb-0 ml-0 relative z-10 max-w-2xl lg:mt-0 lg:w-5/12">
						<div
							...
							<!-- <form style="width: 100%;" @submit.prevent="userStore.authenticateCreate(signup.name, signup.email, signup.pass, signup.confirmPass)">   -->
								<div   class="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8">
									<div class="relative">
										...
										<input placeholder="Ener Your Name" type="text"
											v-model="signup.name"
											class="border placeholder-gray-400 focus:outline-none focus:border-black w-full pt-4 pr-4 pb-4 pl-4 mt-2 mr-0 mb-0 ml-0 text-base block bg-white border-gray-300 rounded-md" required/>
									</div>
									<div class="relative">
										<p
											class="bg-white pt-0 pr-2 pb-0 pl-2 -mt-3 mr-0 mb-0 ml-2 font-medium text-gray-600 absolute">
									...
									<div class="relative">
										<button type="submit"
											class="w-full inline-block pt-4 pr-5 pb-4 pl-5 text-xl font-medium text-center text-white bg-indigo-500 rounded-lg transition duration-200 hover:bg-indigo-600 ease">Submit</button>
									</div>
								</div>
							</form>
						</div>
