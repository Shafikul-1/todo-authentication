				...
				<div class="flex relative inline-block float-right">
				  ...
				  <div class="relative text-sm text-gray-100">
					  ...
					  <div id="userMenu" class="bg-gray-900 rounded shadow-md mt-2 absolute mt-12 top-0 right-0 min-w-full overflow-auto z-30 invisible">
						  <ul class="list-reset">
							<li><RouterLink to="/" class="px-4 py-2 block text-gray-100 hover:bg-gray-800 no-underline hover:no-underline">My account</RouterLink></li>
							<li><RouterLink to="/" class="px-4 py-2 block text-gray-100 hover:bg-gray-800 no-underline hover:no-underline">Notifications</RouterLink></li>
							<li><hr class="border-t mx-2 border-gray-400"></li>
							<li><RouterLink to="/" class="px-4 py-2 block text-gray-100 hover:bg-gray-800 no-underline hover:no-underline">Logout</RouterLink></li>
						  </ul>
					  </div>
				  </div>
			...
			<div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-gray-900 z-20" id="nav-content">
				<ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
					<li class="mr-6 my-2 md:my-0">
                        <RouterLink to="/" class="block py-1 md:py-3 pl-1 align-middle text-blue-400 no-underline hover:text-gray-100 border-b-2 border-blue-400 hover:border-blue-400">
                            <i class="fas fa-home fa-fw mr-3 text-blue-400"></i><span class="pb-1 md:pb-0 text-sm">Home</span>
                        </RouterLink>
                    </li>
					<li class="mr-6 my-2 md:my-0" >
                        <RouterLink to="/login" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-100 border-b-2 border-gray-900  hover:border-pink-400" v-if="!userStore.notauthenticate">
                            <i class="fas fa-tasks fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Login</span>
                        </RouterLink>
                        <RouterLink to="/" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-100 border-b-2 border-gray-900  hover:border-pink-400" v-else>
                            <i class="fas fa-tasks fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Contact</span>
                        </RouterLink>
                    </li>
                    <li class="mr-6 my-2 md:my-0">
                        <RouterLink to="/signup" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-100 border-b-2 border-gray-900  hover:border-purple-400"  v-if="!userStore.notauthenticate">
                            <i class="fa fa-envelope fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Sign Up</span>
                        </RouterLink>
                        <RouterLink to="/todo" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-100 border-b-2 border-gray-900  hover:border-purple-400" v-else>
                            <i class="fa fa-envelope fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Todo App</span>
                        </RouterLink>
                    </li>
                    <li class="mr-6 my-2 md:my-0">
                        <RouterLink to="/dashboard" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-100 border-b-2 border-gray-900  hover:border-green-400">
                            <i class="fas fa-chart-area fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Dashboard</span>
                        </RouterLink>
                    </li>
                    <li class="mr-6 my-2 md:my-0">
                        <button @click="userStore.notauthenticate" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-100 border-b-2 border-gray-900  hover:border-red-400">
                            <i class="fa fa-wallet fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm text-white">Log Out</span>
                        </button>
                    </li>
				</ul>
                ...
                <div class="w-full p-3">
                    ...
                    <div class="bg-gray-900 border border-gray-800 rounded shadow">
                        ...
                        <div class="p-5">
                            ...
                            <p class="py-2"><RouterLink to="/" class="text-white">See More issues...</RouterLink></p>
